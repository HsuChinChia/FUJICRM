...
const API = 'account/manage/modify';
...
function formater(result: typeModify.response) {
  const p3_ape_email = result.profile.p3_account_profile.p3_ape_email;
  const p3_ape_tel = result.profile.p3_account_profile.p3_ape_tel;
  return {
    ...result,
    p3_account: {
      ...result.p3_account,
      p3_ant_created_at: timeFormater(result.p3_account.p3_ant_created_at),
      p3_ape_name: result.profile?.p3_account_profile?.p3_ape_name,
      p3_ape_birthday:
        timeFormater(result.profile?.p3_account_profile?.p3_ape_birthday) ||
        undefined,
      p3_ape_gender: result.profile?.p3_account_profile?.p3_ape_gender || undefined,
      p3_ape_email: p3_ape_email ? JSON.parse(p3_ape_email) : [],
      p3_ape_tel: p3_ape_tel ? JSON.parse(p3_ape_tel) : []
    },
