        ...
        <div class="card-body d-lg-flex flex-wrap">
          ...
          <template v-if="PROFILE_TYPE === 'SIMPLE'">
            <div class="w-100 d-lg-flex flex-wrap">
              ...
              >
                <span>
                  {{ form.p3_account.p3_ape_tel[0] }}
                </span>
              </el-form-item>
              <el-form-item label="email" class="col-lg-6 col-xl-4">
                <span>
                  {{ form.p3_account.p3_ape_email[0] }}
                </span>
              </el-form-item>
            </div>
          </template>
          ...
          <template v-if="PROFILE_TYPE === 'FULL'">
            <el-form-item
              ...
              class="col-lg-6 col-xl-4"
            >
              {{ form.p3_account["p3_ape_birthday"] || "&nbsp;" }}
            </el-form-item>
            ...
            >
              <status
                :value="form.p3_account['p3_ape_gender']"
...
export default {
  ...
  setup() {
    ...
    onMounted(() => {
      ...
      proxy.$bus.$on("modify", () => {
        $router.push(
          `/account/manage/modify?p3_ant_id=${$route.query.p3_ant_id}`
        );
      });
      getInfo();
    });
